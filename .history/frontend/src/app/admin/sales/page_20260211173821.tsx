...
import { CalendarIcon, CurrencyDollarIcon, PlusIcon, TrashIcon, PencilIcon } from '@heroicons/react/24/outline';
              ...
              <tbody>
                {sales.map((sale) => (
                  <tr key={sale.id} className="border-b border-gray-700 hover:bg-gray-750 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm font-semibold text-green-400">R$ {sale.amount.toFixed(2)}</td>
