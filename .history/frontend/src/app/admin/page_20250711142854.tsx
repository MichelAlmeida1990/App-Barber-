...
export default function AdminDashboard() {
  ...
  return (
    <AdminLayout>
      ...
      <div className="pb-5 border-b border-amber-200 mb-6 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-lg p-6 shadow-sm">
        <div className="flex items-center">
          ...
          <div>
            <div className="flex items-center mb-2">
              <h1 className="text-3xl font-bold leading-6 text-amber-900">Dashboard</h1>
      ...
      <div>
        <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((item) => (
            <div
              key={item.name}
              className="relative bg-gradient-to-br from-white to-amber-50 border border-amber-200 pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow-lg rounded-lg overflow-hidden"
            >
              <dt>
                <div className="absolute bg-gradient-to-br from-amber-500 to-yellow-600 rounded-md p-3">
                  <Image 
                ...
                <p className="ml-16 text-sm font-medium text-amber-700 truncate">{item.name}</p>
              </dt>
              <dd className="ml-16 pb-6 flex items-baseline sm:pb-7">
                <p className="text-2xl font-semibold text-amber-900">{item.stat}</p>
                <p
