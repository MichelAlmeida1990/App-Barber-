...
export default function AdminDashboard() {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      console.log('📡 Fetching appointments from:', `${API_BASE_URL}/api/v1/appointments/`);
      const appointmentsRes = await fetch(`${API_BASE_URL}/api/v1/appointments/`, {
        ...
        throw new Error(`Falha ao conectar com API de agendamentos: ${err.message}`);
      });
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <button 
            ...
            disabled={loading}
            className="relative group bg-gray-800 border border-gray-700 hover:border-gray-600 p-6 rounded-lg transition-all duration-300 disabled:opacity-50 hover:bg-gray-750"
          >
            <div>
              <span className="rounded-lg inline-flex p-3 bg-blue-900/30 text-blue-400">
          ...
          <Link 
            href="/admin/clients"
            className="relative group bg-gray-800 border border-gray-700 hover:border-gray-600 p-6 rounded-lg transition-all duration-300 hover:bg-gray-750"
          >
            <div>
              <span className="rounded-lg inline-flex p-3 bg-green-900/30 text-green-400">
          ...
          >
            <div>
              <span className="rounded-lg inline-flex p-3 bg-purple-900/30 text-purple-400">
                <CalendarIcon className="h-6 w-6" aria-hidden="true" />
              </span>
            </div>
            <div className="mt-4">
          ...
          >
            <div>
              <span className="rounded-lg inline-flex p-3 bg-orange-900/30 text-orange-400">
