...
class Barbershop(Base):
    ...
    products = relationship("Product", back_populates="barbershop", cascade="all, delete-orphan")
    sales = relationship("Sale", back_populates="barbershop", cascade="all, delete-orphan")
