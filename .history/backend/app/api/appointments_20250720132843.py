...
async def create_appointment_simple(
    ...
    """Criar agendamento simples (sem banco de dados)"""
    ...
    try:
        ...
        appointment_id = 12345  # ID simulado
        ...
        return {
            ...
            "appointment": {
                "id": appointment_id,
                "barber_id": appointment_data['barber_id'],
                "services": appointment_data['service_ids'],
                "date": appointment_data['appointment_date'],
                "time": appointment_data['time'],
                "status": "SCHEDULED",
                "total_price": 50.00,  # Preço simulado
                "total_duration": 60,  # Duração simulada
...
async def get_my_appointments_test():
    """Listar agendamentos de teste (sem banco de dados)"""
    ...
    mock_appointments = [
        {
            "id": 12345,
            "client_id": 1,
            "client_name": "Michel Paulo",
            "barber_id": 1,
            "barber_name": "Barbeiro 1",
            "services": [
                {"id": 1, "name": "Corte Masculino", "price": 30.00}
            ],
            "appointment_date": "2025-07-21T10:00:00",
            "status": "SCHEDULED",
            "total_price": 30.00,
            "total_duration": 60,
            "notes": "Primeiro agendamento",
            "created_at": "2025-07-20T16:30:00"
        },
        {
            "id": 12346,
            "client_id": 1,
            "client_name": "Michel Paulo",
            "barber_id": 2,
            "barber_name": "Barbeiro 2",
            "services": [
                {"id": 2, "name": "Barba", "price": 20.00},
                {"id": 3, "name": "Sobrancelha", "price": 15.00}
            ],
            "appointment_date": "2025-07-22T14:30:00",
            "status": "SCHEDULED",
            "total_price": 35.00,
            "total_duration": 90,
            "notes": "Barba + sobrancelha",
            "created_at": "2025-07-20T16:35:00"
        }
    ]
