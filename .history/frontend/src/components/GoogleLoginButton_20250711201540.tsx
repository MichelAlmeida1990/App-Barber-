...
export default function GoogleLoginButton({ 
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      if (window.google) {
        // Configuração moderna compatível com FedCM
        window.google.accounts.id.initialize({
          client_id: process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || "seu-google-client-id.apps.googleusercontent.com",
  ...
  const handleGoogleLogin = () => {
    ...
    try {
      if (window.google) {
        // Usar renderButton diretamente - método mais estável
