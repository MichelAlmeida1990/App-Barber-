...
export default function ClientsPage() {
  ...
  return (
    <AdminLayout>
      <div className="pb-5 border-b border-amber-200 sm:flex sm:items-center sm:justify-between mb-6 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-lg p-6 shadow-sm">
        <div className="flex items-center">
          ...
          <div>
            <div className="flex items-center mb-2">
              <h1 className="text-3xl font-bold leading-6 text-amber-900">Clientes</h1>
              <Image src="/images/barbershop/comb.svg" alt="" width={24} height={8} className="ml-3 opacity-50" />
            </div>
            <p className="max-w-4xl text-sm text-amber-700">
        ...
        <div className="mt-3 sm:mt-0 sm:ml-4">
          <button
            onClick={testAPI}
            disabled={loading}
            className="inline-flex items-center px-3 py-2 border border-amber-300 rounded-md shadow-sm text-sm font-medium text-amber-700 bg-amber-50 hover:bg-amber-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 disabled:opacity-50 mr-3"
          >
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Média de Visitas</dt>
                  <dd className="text-lg font-medium text-gray-900">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Total Pontos</dt>
                  <dd className="text-lg font-medium text-gray-900">
