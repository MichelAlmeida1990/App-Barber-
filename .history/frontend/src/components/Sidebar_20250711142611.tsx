  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-gradient-to-b from-amber-900 via-amber-800 to-yellow-900 border-r border-yellow-600/30">
      ...
      <div className="flex justify-center py-2">
        <Image src="/images/barbershop/barber-pole.svg" alt="" width={20} height={40} className="opacity-30" />
      </div>
      
      <div className="flex flex-shrink-0 bg-gradient-to-r from-amber-800 to-yellow-800 border-t border-yellow-600/30 p-4">
        <div className="group block w-full flex-shrink-0">
          <div className="flex items-center">
            <div className="inline-block h-9 w-9 rounded-full bg-yellow-600 border-2 border-yellow-400">
              <div className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-yellow-500 to-amber-600">
                <Image src="/images/barbershop/scissors.svg" alt="" width={16} height={16} className="opacity-80" />
              </div>
            </div>
            <div className="ml-3">
              <p className="text-sm font-medium text-yellow-100">Administrador</p>
              <p className="text-xs font-medium text-yellow-300">Elite Barber Shop</p>
            </div>
          </div>
          ...
          <div className="flex items-center mt-2">
            ...
            <span className="text-xs text-yellow-300">Sistema Online</span>
          </div>
        </div>
      </div>
    </div>
